        ...
        stage("notification") {
			steps {
                telegramSend(
                            ...
                            message: 'Извините, последний раз пробую. Результаты тестов тут -> https://jenkins.lmru.adeo.com/job/lego-front/view/MAGASIN%20mobile/job/lego-front-android-Run_API_tests/${env.BUILD_NUMBER}/allure'
                        )
			}
        }
    }
