...
public class BitrixHelper extends BaseHelper {
  ...
  private BitrixSolutionPayload createBitrixPayload(OnlineOrderTypeData orderData,
    ...
    payload.setUserData(makeUserDataPayload());
...
//        .collect(Collectors.toList());
  ...
  private BitrixSolutionPayload makeGeneralPayload(OnlineOrderTypeData orderData, ShopData shop) {
    ...
    payload
        .setDateStatusFormat(dateTime.format(DateTimeFormatter.ofPattern("dd.MM.yyyy HH:mm:ss")));
    payload.setDateInsertFormat(
        dateTime.toLocalDate().format(DateTimeFormatter.ofPattern("dd.MM.yyyy")));
    payload
        .setDateUpdateFormat(dateTime.format(DateTimeFormatter.ofPattern("dd.MM.yyyy HH:mm:ss")));
  ...
  private BitrixSolutionPayload.UserData makeUserDataPayload() {
  ...
  private BitrixSolutionPayload.DeliveryData makeDeliveryDataPayload(OnlineOrderTypeData orderData,
      ShopData shop) {
    String comment = "BITRIX: " + orderData.getDeliveryType() + ", " + orderData.getPaymentType();

    BitrixSolutionPayload.DeliveryData payload = new BitrixSolutionPayload.DeliveryData();
    payload.setDate(
        dateTime.plusDays(1).toLocalDate().format(DateTimeFormatter.ofPattern("dd.MM.yyyy")));
