...
public class DoorWorkflowShortTest extends BaseMagPortalApiTest {
    ...
    @Test(description = "C3310199 Door Delivery: ALLOWED_FOR_PICKING -> PICKING_IN_PROGRESS")
    ...
    @Test(description = "C3310199 Door Delivery: PICKING_IN_PROGRESS -> PICKED", dependsOnMethods={"testStartPicking"})
    ...
    @Test(description = "C3310199 Door Delivery: ALLOWED_FOR_GIVEAWAY -> ON_SHIPMENT", dependsOnMethods={"testCompletePicking"})
    ...
    @Test(description = "C3310199 Door Delivery: ON_SHIPMENT -> DELIVERED", dependsOnMethods={"testShipped"})
