...
public class DoorWorkflowShortTest extends BaseMagPortalApiTest {
    ...
    @Test(description = "C3310199 Door Delivery: PICKING_IN_PROGRESS -> PICKED", priority = 2)
    ...
    @Test(description = "C3310199 Door Delivery: ALLOWED_FOR_GIVEAWAY -> ON_SHIPMENT", priority = 3)
    public void testShipped() throws Exception {
    ...
    @Test(description = "C3310199 Door Delivery: ON_SHIPMENT -> DELIVERED", priority = 4)
    public void testDeliver() throws Exception {
        orderClient.waitUntilOrderGetStatus(currentOrderId,
                States.SHIPPED.getApiVal(), PaymentStatusEnum.PAID.toString());
