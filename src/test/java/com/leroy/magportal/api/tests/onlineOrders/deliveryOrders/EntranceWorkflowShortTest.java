...
public class EntranceWorkflowShortTest extends BaseMagPortalApiTest {
    ...
    @Test(description = "C23425627 Entrance Delivery: PICKING_IN_PROGRESS -> PICKED", dependsOnMethods={"testStartPicking"})
    ...
    @Test(description = "C23425627 Entrance Delivery: ALLOWED_FOR_GIVEAWAY -> ON_SHIPMENT", dependsOnMethods={"testCompletePicking"})
    ...
    @Test(description = "C23425627 Entrance Delivery: ON_SHIPMENT -> DELIVERED", dependsOnMethods={"testShipped"})
