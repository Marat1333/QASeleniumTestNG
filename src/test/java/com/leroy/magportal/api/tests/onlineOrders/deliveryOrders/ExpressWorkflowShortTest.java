...
public class ExpressWorkflowShortTest extends BaseMagPortalApiTest {
    ...
    @Test(description = "C3310199 Express Delivery: ALLOWED_FOR_PICKING -> PICKING_IN_PROGRESS", priority = 1)
    ...
    @Test(description = "C3310199 Express Delivery: PICKING_IN_PROGRESS -> PICKED", priority = 2, dependsOnMethods={"testStartPicking"})
    ...
    @Test(description = "C3310199 Express Delivery: ALLOWED_FOR_GIVEAWAY -> ON_SHIPMENT", priority = 3, dependsOnMethods={"testCompletePicking"})
    ...
    @Test(description = "C3310199 Express Delivery: ON_SHIPMENT -> DELIVERED", priority = 4, dependsOnMethods={"testShipped"})
