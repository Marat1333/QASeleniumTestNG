...
public class TestDataConstants extends EnvConstants {
    ...
    public static final SimpleCustomerData SIMPLE_CUSTOMER_DATA_1 = new SimpleCustomerData()
            .toBuilder()
    ...
    public static final SimpleCustomerData SIMPLE_CUSTOMER_DATA_2 = new SimpleCustomerData()
            .toBuilder()
    ...
    public static final SimpleCustomerData CUSTOMER_WITH_PROFESSIONAL_CARD = new SimpleCustomerData()
            .toBuilder()
    ...
    public static final SimpleCustomerData CUSTOMER_WITH_SERVICE_CARD = new SimpleCustomerData()
            .toBuilder()
