...
public class SearchTest extends AppBaseSteps {
    ...
    private HashMap<Integer, ThreadApiClient<ProductData, MagMobileClient>> sendRequestsSearchProductsBy(
            GetCatalogSearch... paramsArray) {
        HashMap<Integer, ThreadApiClient<ProductData, MagMobileClient>> resultMap = new HashMap<>();
        int i = 0;
        for (GetCatalogSearch param : paramsArray) {
            ThreadApiClient<ProductData, MagMobileClient> myThread = new ThreadApiClient<>(
                    apiClient);
    ...
    private HashMap<Integer, ThreadApiClient<ServiceData, MagMobileClient>> sendRequestsSearchServicesBy(
            GetCatalogServicesSearch... paramsArray) {
        HashMap<Integer, ThreadApiClient<ServiceData, MagMobileClient>> resultMap = new HashMap<>();
        int i = 0;
        for (GetCatalogServicesSearch param : paramsArray) {
            ThreadApiClient<ServiceData, MagMobileClient> myThread = new ThreadApiClient<>(
                    apiClient);
    ...
    public void testC3200996() throws Exception {
        ...
        HashMap<Integer, ThreadApiClient<ProductData, MagMobileClient>> apiThreads =
        ...
        ProductData d1 = apiThreads.get(0).getData();
        ...
        searchProductPage = productCardPage.returnBack();
        ProductData d2 = apiThreads.get(1).getData();
        ...
        ProductData d3 = apiThreads.get(2).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
        ...
        ProductData d4 = apiThreads.get(3).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
    ...
    public void testC22846686() throws Exception {
        ...
        ProductData gammaResponse = apiThreads.get(0).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
        ...
        filterPage.applyChosenFilters();
        ProductData topResponse = apiThreads.get(1).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
        ...
        filterPage.applyChosenFilters();
        ProductData bestPriceResponse = apiThreads.get(2).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
        ...
        filterPage.applyChosenFilters();
        ProductData orderedProductResponse = apiThreads.get(3).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
        ...
        filterPage.applyChosenFilters();
        ProductData supplierResponse = apiThreads.get(5).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
        ...
        ProductData avsDateResponse = apiThreads.get(4).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(
    ...
    public void testC22789209() throws Exception {
        LocalDate avsDate = LocalDate.of(2019, 7, 21);
        ...
        allGammaFilterPage.applyChosenFilters();
        ProductData ctmProductResponse = apiThreads.get(1).getData();
        ...
        allGammaFilterPage.applyChosenFilters();
        ProductData commonProductTypeProductResponse = apiThreads.get(2).getData();
        ...
        allGammaFilterPage.applyChosenFilters();
        searchProductPage.verifyRequiredElements();
        ProductData avsDateProductResponse = apiThreads.get(3).getData();
    ...
    public void testC22789201() throws Exception {
        ...
        ProductData departmentNomenclatureResponce = apiThreads.get(3).getData();
        ...
        ProductData subdepartmentNomenclatureResponce = apiThreads.get(2).getData();
        ...
        ProductData classNomenclatureResponce = apiThreads.get(1).getData();
        ...
        ProductData subclassNomenclatureResponce = apiThreads.get(0).getData();
    ...
    public void testSearchPagePagination() throws Exception {
        ...
        ProductData paginationResponce = apiThreads.get(0).getData();
    ...
    public void testSuppliersFilter() throws Exception {
        ...
        myShopFilterPage.applyChosenFilters();
        ProductData suppliersResponce = apiThreads.get(0).getData();
        ...
        myShopFilterPage.applyChosenFilters();
        ProductData defaultParamsResponce = apiThreads.get(1).getData();
    ...
    public void testServicesSearch() throws Exception {
        ...
        HashMap<Integer, ThreadApiClient<ServiceData, MagMobileClient>> apiThreads =
        ...
        nomenclatureSearchPage.returnBackNTimes(1);
        nomenclatureSearchPage.clickShowAllProductsBtn();
        ServiceData allServicesResponce = apiThreads.get(0).getData();
        ...
        ServiceData shortLmCodeServicesResponce = apiThreads.get(2).getData();
        ...
        ServiceData fullLmCodeServicesResponce = apiThreads.get(3).getData();
        ...
        nomenclatureSearchPage.clickShowAllProductsBtn();
        ServiceData departmentServicesResponce = apiThreads.get(1).getData();
        ...
        ServiceData shortNameServicesResponce = apiThreads.get(4).getData();
        ...
        addServicePage.verifyRequiredElements()
                .shouldServiceNameAndLmCodeBeOnPage(SERVICE_FULL_NAME, SERVICE_FULL_LM_CODE);
        addServicePage.returnBack();
        ServiceData fullNameServicesResponce = apiThreads.get(5).getData();
    ...
    public void testClearAllFilters() throws Exception {
        ...
        filterPage.applyChosenFilters();
        ProductData defaultParamsResponce = apiThreads.get(0).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(defaultParamsResponce,
                SearchProductPage.CardType.COMMON, entityCount);
    }
    ...
    public void testAvsFilterBehaviour() throws Exception {
        ...
        myShopFilterPage.applyChosenFilters();
        ProductData avsParamsResponce = apiThreads.get(0).getData();
        ...
        myShopFilterPage.choseCheckBoxFilter(FilterPage.AVS);
        myShopFilterPage.applyChosenFilters();
        ProductData avsNeqNullParamsResponce = apiThreads.get(1).getData();
    ...
    public void testSwitchBetweenMyShopAndAllGammaFilters() throws Exception {
        ...
        myShopFilterPage.applyChosenFilters();
        ProductData myShopFilterResponce = apiThreads.get(0).getData();
        ...
        allGammaFilterPage.applyChosenFilters();
        ProductData allGammaFilterResponce = apiThreads.get(1).getData();
    ...
    public void testFilterCounter() throws Exception {
        ...
        // Step 1
        log.step("Выбрать фильтр topEm, дату AVS и двух поставщиков в фильтре поставщиков");
    ...
    public void testAllGammaSort() throws Exception {
        ...
        // Step 3
        log.step("Нажать на кнопку сортировки");
        SortPage sortPage = searchProductPage.openSortPage();
        sortPage.shouldSortIsOnlyByLmCode();

        // Step 4
        log.step("Выбрать сортировку по лм коду ASC");
        sortPage.selectSort(SortPage.SORT_BY_LM_ASC);
        ProductData allGammaLmAscResponce = apiThreads.get(1).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(allGammaLmAscResponce, SearchProductPage.CardType.ALL_GAMMA, 3);

        // Step 5
        log.step("Перейти в фильтры и переключиться на фильтр \"Мой магазин\"");
        searchProductPage.goToFilterPage();
        ...
        log.step("Нажать \"показать товары\"");
        filterPage.applyChosenFilters();
        ProductData myShopLmAscResponce = apiThreads.get(2).getData();
        ...
        searchProductPage.openSortPage();
        sortPage.selectSort(SortPage.SORT_BY_AVAILABLE_STOCK_ASC);
        ProductData myShopStockAscResponce = apiThreads.get(3).getData();
        searchProductPage.shouldCatalogResponseEqualsContent(myShopStockAscResponce, SearchProductPage.CardType.COMMON, 3);

        // Step 8
        log.step("Перейти в фильтры, выбрать фильтр \"Вся гамма ЛМ\" и показать товары");
        searchProductPage.goToFilterPage();
        filterPage.switchFiltersFrame(FilterPage.ALL_GAMMA_FRAME_TYPE);
        filterPage.applyChosenFilters();
        ProductData allGammaLmDescResponce = apiThreads.get(0).getData();
    ...
    public void testFiltersHide() throws Exception {
        ...
        // Step 2
        log.step("Нажать на \"Показать все фильтры\"");
        filterPage.clickShowAllFiltersBtn();
        filterPage.shouldFilterPageHasExtendedView();

        // Step 3
        log.step("Выбрать любую гамму/топ и применить фильтр");
        filterPage.choseTopFilter(FilterPage.TOP + " " + TOP);
        filterPage.applyChosenFilters();
        ...
        // Step 5
        log.step("Нажать на \"Показать все фильтры\", выбрать фильтр среди вновь отображенных и нажать \"Показать товары\"");
        filterPage.clickShowAllFiltersBtn();
        filterPage.choseCheckBoxFilter(FilterPage.BEST_PRICE);
        filterPage.applyChosenFilters();
