...
public class StockProductCardPage extends CommonMagMobilePage {
    ...
    public StockProductCardPage enterCountOfItems(String quantity) {
        quantityItemsFld.clearAndFill(quantity);
        return this;
    }

    @Step("Нажать кнопку ОТОЗВАТЬ для ввода кол-ва товара")
    public StockProductCardPage clickWithdrawalBtnForEnterQuantity() {
        withdrawalBtn.click();
        return this;
    }
    ...
    public StockProductCardPage shouldWithdrawalButtonHasQuantity(String count) {
